...
HDFS_OUTPUT_PATH = "hdfs://host.docker.internal:8020/user/hive/warehouse/users"
...
spark.conf.set("spark.hadoop.fs.defaultFS", "hdfs://172.19.0.14:50070")
spark.conf.set("spark.kafka.consumer.pollTimeoutMs", "10000")  # Set a higher timeout
